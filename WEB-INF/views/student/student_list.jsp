...
<body>
	...
	<div id="addDialog" style="padding: 10px;">
		...
		<form id="addForm" method="post">
	    	<table id="addTable2"  cellpadding="8">
				<input id="add_photo" type="hidden" name="photo" value="../photo/student.jpg"  />
	    		<tr>
	    			<td>学生名:</td>
	    			<td>
	    				<input id="add_name"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="username" data-options="required:true, missingMessage:'请输入学生名'" />
	    			</td>
	    		</tr>
				<tr>
					<td>登录密码:</td>
					<td>
						<input id="add_password"  class="easyui-textbox" style="width: 200px; height: 30px;" type="password" name="password" data-options="required:true, missingMessage:'请输入学生登录密码'" />
					</td>
				</tr>
				<tr>
					<td> 所属班级:</td>
	...
	<!-- 提交表单处理iframe框架 将头像表单处理提交到该界面。因此不会每次更改都发起请求刷新界面-->
